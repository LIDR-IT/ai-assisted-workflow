...
<Note>
  **Multi-Platform Implementation:** This project uses a simplified hooks system across Claude Code, Gemini CLI, and Cursor. For platform-specific details, see:
  - [Hooks Quick Reference](../../guides/hooks/hooks-quick-reference.md) - Cross-platform comparison
  - [Platform Support Guide](../../guides/hooks/HOOKS_PLATFORM_SUPPORT.md) - Detailed platform differences
  - [Cursor Hooks Reference](./cursor-hooks.md) - Cursor-specific (Notification event not supported)
  - [Gemini CLI Hooks](./gemini-cli-hooks.md) - Gemini-specific (pure JSON stdout required)
</Note>

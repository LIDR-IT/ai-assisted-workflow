...
| **PO / Producto**   | PRD Funcional, User Stories, priorización, sign-off funcional | prd-funcional, user-stories, generate-rf                                 | PRD-F, US, RFs               |
...
| **Gate 2**     | Especificación RF | Producto + QA     | RFs completos, coherencia validada, testables, dependency map                  | `skills/validate-requirements/checklists/rf-coherence.md`                                                               |

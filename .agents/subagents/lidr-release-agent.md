...
# External docs/chat/tracking routed through abstraction skills lidr-external-sync + lidr-sdlc-tracking
# ({{DOCS_TOOL}} / {{CHAT_TOOL}} / {{TRACKING_TOOL}} resolved via _shared/lidr/integrations/tool-registry.yaml); GitHub via gh/git primitives
mcps:
  - filesystem

...
status: active
triggerType: manual
# External docs/chat routed through the abstraction skill lidr-external-sync
# ({{DOCS_TOOL}} / {{CHAT_TOOL}} resolved via _shared/lidr/integrations/tool-registry.yaml)
mcps:
  - filesystem
evolvedFrom: /lidr-help (Tier 3 utility skill/command)
---

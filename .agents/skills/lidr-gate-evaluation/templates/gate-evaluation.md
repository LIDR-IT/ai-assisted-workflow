...
> Standardized output template for `/advance-gate`. All gates (0-7) use this format.
> Generated automatically by the `/advance-gate {N}` command.
...
_Generated by `/advance-gate {N}` using tpl-gate-evaluation v1.1.0_

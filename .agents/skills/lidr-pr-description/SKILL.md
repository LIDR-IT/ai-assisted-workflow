...
| Jira ticket (BDD criteria, US, RF) | ✅        | Manual or script                  |
...
**Ticket:** [{PROJ-XXX}]({jira_url}) — {US title}
...
- [x] No TODOs without linked Jira ticket
...
- "How to Test" maps 1:1 to BDD acceptance criteria from the Jira ticket.

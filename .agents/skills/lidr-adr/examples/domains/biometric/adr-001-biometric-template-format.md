...
{{CLIENT_NAME}} currently uses different proprietary template formats for face, voice, and document biometrics across our SDK portfolio. This creates several challenges:

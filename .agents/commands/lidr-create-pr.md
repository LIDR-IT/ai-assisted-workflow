...
allowed-tools: Read, Write, Bash(git:*), Bash(npm:*), AskUserQuestion
model: sonnet
---
...
ARGUMENTS:
  ...
  Flags in $ARGUMENTS: --handoff, --draft, --no-notify
...
If $ARGUMENTS does NOT contain "--no-notify":

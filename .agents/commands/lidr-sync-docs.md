...
argument-hint: [scope]
allowed-tools: Read, Write, Edit, Grep, Bash(git:*), Bash(find:*), Bash(cat:*), Bash(jq:*), AskUserQuestion
model: inherit
---
...
- Tables/models in code NOT in specs/storage.md (or the project's architecture doc)

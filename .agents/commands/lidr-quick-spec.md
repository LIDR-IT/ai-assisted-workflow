...
1. **lidr-generate-rf** (simplified mode - max 8 RFs)
2. **lidr-user-stories** (single story generation)
3. **lidr-validate-requirements** (lightweight validation)
...
- Uses lightweight versions of `lidr-generate-rf` and `lidr-user-stories`
- Can trigger `lidr-validate-requirements` for consistency check

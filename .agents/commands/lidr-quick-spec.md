...
/lidr-quick-spec biometric-timeout-fix --type=bugfix --effort=8
...
- **Post**: `/lidr-implement-ticket` can use quick spec as input
- **Chain**: `/lidr-quick-spec` → `/create-test-cases` → `/lidr-implement-ticket`

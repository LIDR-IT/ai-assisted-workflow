...
USAGE:
  /lidr-validate-prd my-project               # Validates both PRDs
  /lidr-validate-prd my-project funcional     # Validates only PRD-F
  /lidr-validate-prd my-project tecnico       # Validates only PRD-T
...
RELATED COMMANDS:
  /lidr-advance-gate 0   - Must have passed before PRD creation
  /lidr-advance-gate 1   - Run after this command to evaluate Gate 1
  /lidr-validate-requirements - Next command after Gate 1 approval
...
Load: @../rules/lidr-sdlc/org.md and @../rules/lidr-sdlc/project.md and @../rules/lidr-sdlc/documentation.md
...
If "$1" is empty:
❌ Project name required. Usage: /lidr-validate-prd [project-name] [prd-type]
Exit.
...
Load: @../skills/lidr-business-case/SKILL.md for reference
...
If both PRD-F and PRD-T exist, execute cross-review using skill `lidr-review-cruzado`:
...
- If APPROVE: Proceed to `/lidr-advance-gate 1`

...
const rawSkills: Omit<Skill, 'phaseNum'>[] = [
  ...
  // Phase 3 — Solutioning · specification (ex-Fase 3 Especificación) (1)
  {
    ...
    criticality: 'required',
    description:
      'Requirements spec workflow (RF + NFR + RTM). Fuses generate-rf + generate-nfr + validate-requirements into 5 modes: per-rf, nfr, validate (5-pass RTM, Gate 2), living-spec, brownfield-audit.',
    triggers: [

...
export const roadmapTabData: readonly RoadmapItem[] = [
  {
    ...
    items: [
      ...
      '✓ Templates integrados en skills (arquitectura self-contained) — catálogo de evidencia por gate alineado con gate-evidence.yaml (ver /handoffs)',
      ...
      '✓ release-notes + retrospective + cross-cutting skills (generate-rule, implementation-phases) + BMad-owned (bmad-create-architecture, bmad-ux, bmad-retrospective)',

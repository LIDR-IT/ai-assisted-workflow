        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '7 LIDR', color: 'bg-emerald-100 text-emerald-700' },
              ...
              },
              {
                ...
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '5 LIDR', color: 'bg-emerald-100 text-emerald-700' },
                desc: 'Stage anytime: skills para extender la plataforma Claude Code (skills, commands, hooks, rules, MCPs).',
                children: [
                  {
                  ...
                  {
                    name: 'lidr-command-development/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                  ...
                  {
                    name: 'lidr-generate-rule/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                  ...
                  {
                    name: 'lidr-hook-development/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                  ...
                  {
                    name: 'lidr-mcp-integration/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },

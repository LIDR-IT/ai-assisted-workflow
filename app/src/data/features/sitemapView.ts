  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        desc: 'Self-contained skills agrupados por las 5 fases unificadas (BMad × LIDR — ver UNIFIED-PHASES.md), con sub-carpetas por stage y badge de fuente LIDR/BMad',
        children: [
          {
            ...
            children: [
              ...
              {
                name: 'anytime — Governance & utilidades (LIDR)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '6 LIDR', color: 'bg-emerald-100 text-emerald-700' },
                desc: 'Stage anytime: gate orchestration, auditoría, tracking y utilidades cross-cutting.',
                children: [
                  {
              ...
              {
                name: 'anytime — Meta-tooling (LIDR)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '1 LIDR', color: 'bg-emerald-100 text-emerald-700' },
                desc: 'Stage anytime: skill umbrella para extender la plataforma Claude Code (skills, commands, subagents, hooks, rules, MCPs).',
                children: [
                  {
                    name: 'lidr-agents-architecture/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Meta-skill umbrella: crear skills/commands/subagents/hooks/MCPs/rules con sync automático cross-platform (command/hook/mcp/rule-development en references/)',
                    docPath: '.claude/skills/lidr-agents-architecture/SKILL.md',
                  },
                ],
              },
              {
                name: 'anytime — Persona agents BMM + TEA',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '7 BMad', color: 'bg-amber-50 text-amber-700' },
                desc: 'Stage anytime: conversational specialist agents.',
                children: [
                  {
              ...
              {
                name: 'anytime — CIS (Creative Intelligence Suite)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '10 BMad', color: 'bg-amber-50 text-amber-700' },
                desc: 'Stage anytime: agents y workflows de innovation, design thinking y storytelling.',
                children: [
                  {
              ...
              {
                name: 'anytime — BMad Builder (meta)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '4 BMad', color: 'bg-amber-50 text-amber-700' },
                desc: 'Stage anytime: meta-tooling para extender BMad mismo.',
                children: [
                  {
                ...
                children: [
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Genera borrador de Business Case (⭐ evidencia G0)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Research técnico de tecnologías y arquitectura (PoC con GO/NO-GO)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Product brief lightweight para definición rápida (INPUT principal de bmad-prd)',
          ...
          },
          {
            ...
            type: 'folder',
            iconName: 'FolderOpen',
            badge: { label: '3 LIDR + 5 BMad', color: getPhaseColorClass(2) },
            desc: 'Unified Phase 2: PRD unificado, UX y riesgos. Stage: planning (ex-F2 Discovery & PRD). Cierra con Gate 1 (PRD Approved).',
            children: [
              {
                name: 'planning (ex-F2 Discovery & PRD)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '8 skills', color: getPhaseColorClass(2) },
                children: [
                  {
                    name: 'bmad-prd/SKILL.md',
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'PRD unificado: crear/actualizar/validar (intent-based) — ⭐ evidencia G1',
            ...
            children: [
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Architecture solution design para AI agent consistency (⭐ evidencia G2)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Descompone requisitos en epics y user stories (⭐ evidencia G2)',
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Calcula capacidad, velocity y commitment (⭐ evidencia G3)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Valida que PRD/UX/Arch/Epics estén completos (⭐ evidencia G3)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Sprint status tracking desde epics (⭐ evidencia G3)',
          ...
          },
          {
            ...
            children: [
              {
                name: 'development (ex-F5 Desarrollo)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '13 skills', color: getPhaseColorClass(5) },
                desc: 'Stage development → Gate 4: Dev → QA (DoD)',
                children: [
                  {
                  ...
                  {
                    name: 'lidr-impact-analysis/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Análisis de impacto: contratos (G4) + compatibilidad multi-variante (G2) contra registries del cliente',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Genera handoff dev→QA completo (⭐ evidencia G4)',
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Reporta ejecución de testing (⭐ evidencia G5)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Expand test automation coverage (suite de regresión)',
              ...
              {
                name: 'security (ex-F7 Seguridad)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '4 skills', color: getPhaseColorClass(7) },
                desc: 'Stage security → Gate 6: Security Sign-off',
                children: [
                  {
                    name: 'lidr-vuln-assessment/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Interpreta reportes SAST/SCA (⭐ evidencia G6)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: '🤖 AUTOMATED: Security compliance (4h → 5min) (⭐ evidencia G6)',
                    docPath: '.claude/skills/lidr-security-checklist/SKILL.md',
                  },
                ],
              },
              {
                name: 'release (ex-F8 Despliegue)',
                type: 'folder',
                iconName: 'FolderOpen',
                badge: { label: '5 skills', color: getPhaseColorClass(8) },
                desc: 'Stage release → Gate 7: Release a Producción (Gate Final)',
                children: [
                  {
                    name: 'lidr-change-request/SKILL.md',
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Genera Change Request formal (⭐ evidencia G7)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: '🤖 AUTOMATED: Plan de rollback (4h → 5min) (⭐ evidencia G7)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: '🤖 AUTOMATED: Release notes desde PRs (2h → 5min) (⭐ evidencia G7)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'LIDR', color: 'bg-emerald-100 text-emerald-700' },
                    desc: 'Conduce postmortem blameless (solo si hubo incidente)',
                  ...
                  },
                  {
                    ...
                    type: 'file',
                    badge: { label: 'BMad', color: 'bg-amber-100 text-amber-800' },
                    desc: 'Post-epic review para extraer lecciones (post-deploy)',

...
export const HELPCENTER_DOCPATHS: string[] = [
  ...
  '.claude/agents/bmad-agent-pm.agent.md',
  '.claude/agents/bmad-agent-tech-writer.agent.md',
  '.claude/agents/bmad-agent-ux-designer.agent.md',
  '.claude/agents/bmad-cis-agent-brainstorming-coach.agent.md',
  '.claude/agents/bmad-cis-agent-creative-problem-solver.agent.md',
  '.claude/agents/bmad-cis-agent-design-thinking-coach.agent.md',
  '.claude/agents/bmad-cis-agent-innovation-strategist.agent.md',
  '.claude/agents/bmad-cis-agent-presentation-master.agent.md',
  '.claude/agents/bmad-cis-agent-storyteller.agent.md',
  '.claude/agents/bmad-tea.agent.md',
  ...
  '.claude/skills/claude-agents-architecture/SKILL.md',
  '.claude/skills/claude-command-development/SKILL.md',
  '.claude/skills/claude-generate-rule/SKILL.md',
  '.claude/skills/claude-hook-development/SKILL.md',
  '.claude/skills/claude-mcp-integration/SKILL.md',
  ...
  '.claude/skills/lidr-commit-management/SKILL.md',
  ...
  '.claude/skills/lidr-project-classifier/SKILL.md',

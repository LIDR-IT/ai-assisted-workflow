 ...
 * AIBadge Component
 *
 * Displays a badge indicating the type of AI assistance for templates.
 * Extracted from HandoffsTemplates.tsx for better reusability.
 */

import { Brain, FileCode2, Terminal, Zap, Bot, Cable } from 'lucide-react';
import type { Template } from './handoffTypes';

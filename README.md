...
[![Skills](<https://img.shields.io/badge/skills-106%20(37%20LIDR%20%2B%2069%20BMAD)-blue.svg>)](#repository-structure)
...
│   ├── skills/                    # 106 skills (Agent Skills open standard — read natively by Gemini/Copilot/Antigravity)
│   │   ├── lidr-*/                # 37 LIDR SDLC skills (prefixed to avoid collisions)

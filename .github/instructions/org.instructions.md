...
| 1    | **Analysis**          | analysis (ex-F1 Originación)                                       | Gate 0: Intake                                      | Intake poblado (BMad brief/prfaq principal · BC LIDR complementario), sponsor, presupuesto, sign-off PME | PME + Sponsor                                           |

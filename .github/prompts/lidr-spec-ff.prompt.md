...
sub-steps (lidr-prd-tecnico for proposal/design, lidr-generate-rf + lidr-generate-nfr
for spec, lidr-user-stories + spec-execution.md for tasks).
...
Generated:
  ✓ proposal.md      (lidr-prd-tecnico + lidr-prd-funcional)
  ✓ design.md        (lidr-design-doc + ADR references)

...
ls -la .cursor/rules .cursor/skills .cursor/commands .cursor/agents          # Cursor (copies rules, symlinks rest)
ls -la .claude/rules .claude/skills .claude/commands .claude/agents          # Claude (all symlinks to .agents/)
ls -la .gemini/GEMINI.md .gemini/commands                                    # Gemini (index file + TOML commands; skills/agents read natively from .agents/)
ls -la .github/instructions .github/prompts .github/agents                   # Copilot (official path is .github/instructions/, NOT .github/rules/)
...
ls -la .mcp.json .cursor/mcp.json .gemini/settings.json .vscode/mcp.json     # Claude uses .mcp.json at repo root (not .claude/mcp.json)

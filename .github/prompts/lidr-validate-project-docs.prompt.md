...
USAGE:
  /lidr-validate-project-docs my-project
  /lidr-validate-project-docs my-project --fix-frontmatter
...
RELATED COMMANDS:
  /lidr-init-project-docs - Creates docs this command validates
...
Load: @../rules/lidr-sdlc/documentation.md for validation standards.

## Validate Input

If "$1" is empty:
❌ Project name required.
Usage: /lidr-validate-project-docs [project-name]
Exit.
...
Run /lidr-init-project-docs $1 first.
Exit.
...
Per @../rules/lidr-sdlc/documentation.md, verify YAML frontmatter has:
...
If {{{ input }}} contains "--fix-frontmatter":
...
- "Run /lidr-sync-docs $1 to auto-update docs from code"
- "Fix TODOs manually for project-specific content"
- "Run /lidr-validate-project-docs $1 --fix-frontmatter to auto-fix metadata"

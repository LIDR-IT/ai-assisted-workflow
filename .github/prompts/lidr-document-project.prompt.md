...
**Auto-executes:**
2. 📋 **document-discovery** → Inventory existing documents
3. ⚠️ Detect duplicates and conflicts
4. 📝 Present organized inventory
5. 🚫 **BLOCK if critical conflicts** → Must be resolved manually
